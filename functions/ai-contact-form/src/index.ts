/**
 * Cloudflare Worker for Dependable Painting Contact Form
 * - Receives POST requests from the contact form.
 * - Sends the submission to a specified email using the MailChannels API.
 */
